# Terraform Enterprise FDO Deployment on AWS using Podman  and disk operational mode
...
```
git clone https://github.com/mohamed-hashicorp/tfe-fdo-ubuntu-podman-disk.git
```
- Change the directory
```
cd tfe-fdo-podman-dm-si
```
